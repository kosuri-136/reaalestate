   ...
   function colorHandler(){
    setState( window.location.href)
        ...
        //  console.log(state);
         ...
         let state4 = false;
    // const [state,setState]= useState('');
    if (state==="http://localhost:9000/basic") {
        state1 = true;
        state2 = false;
        state3 = false;
       state4 = false;
      } else if  (state==="http://localhost:9000/details") {
        state1 = false;
        state2 = true;
        state3 = false;
       state4 = false;
      } else if  (state==="http://localhost:9000/general") {
        state1 = false;
        state2 = false;
        state3 = true;
       state4 = false;
      } else if(state==="http://localhost:9000/location"){
        state1 = false;
         state2 = false;
         state3 = false;
        state4 = true;
